...
HD_PWD='E:/Projects/SchoolGit/ECEStuff/ECE4305L/PONG/PONG.runs/mmcm_fpro_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmcm_fpro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmcm_fpro.tcl
