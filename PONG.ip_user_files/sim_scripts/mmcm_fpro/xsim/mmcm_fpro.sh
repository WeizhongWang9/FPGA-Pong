...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mmcm_fpro xil_defaultlib.mmcm_fpro xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mmcm_fpro -key {Behavioral:sim_1:Functional:mmcm_fpro} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3914.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mmcm_fpro.wdb xsim.dir)
